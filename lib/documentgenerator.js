 ...
 * @param sourceFile
 */
exports.generateHtml = function (taxonomies, destinations, destinationFile, sourceFile) {
    var self = this;
    ...
    return q.Promise(function (resolve, reject) {
        for (var i = 0; i < destinations.length; i++) {
            ...
            self.createDestinationRepo(tax, destinations[i], destinationFile, sourceFile)
 ...
 * @returns {*}
 */
exports.createDestinationRepo = function (taxonomies, destination, destinationFile, sourceFile) {

    return q.Promise(function (resolve, reject) {
        fse.copy(sourceFile, destinationFile + '/' + destination.name, function (err) {
                if (err) {
                    reject(err);
                }
